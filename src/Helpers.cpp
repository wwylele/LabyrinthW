...
GLint Program::bindVertexAttribArray(
        const std::string &name, VertexBufferObject& VBO, int float_count, int float_offset) const
{
  ...
  glVertexAttribPointer(id, float_count, GL_FLOAT, GL_FALSE, VBO.rows * 4,
    (void*)(uintptr_t(float_offset * 4)));
  check_gl_error();
